...
const entryPoints = {
  ...
  articles: path.resolve(__dirname, 'src/js', 'index.js'),
  ads_search: path.resolve(__dirname, 'src/js', 'index.js'),
  articles_favourite: path.resolve(__dirname, 'src/js', 'index.js'),
  users_favourite: path.resolve(__dirname, 'src/js', 'index.js'),
